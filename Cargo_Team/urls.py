...
urlpatterns = [
    ...
    path('update-pending-order-status/<int:pk>/', views.update_pending_order_status, name='update_pending_order_status'),
    ...
    path('update-pending-return-status/<int:pk>/', views.update_pending_return_status, name='update_pending_return_status'),
